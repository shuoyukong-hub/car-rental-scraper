...
description: 租车数据抓取——携程/哈啰/滴滴/神州四平台车型与价格获取。涉及租车爬虫、租车数据采集、车型价格、携程租车/哈啰租车/滴滴租车/神州租车取数时使用。
version: 1.1.0
metadata:
  hermes:
    tags: [car-rental, ctrip, hellobike, didi, zuche, 租车, 数据采集, 爬虫]
---
...
**要引导使用者准备登录态时,直接让他看 `README.md` 的「准备登录态」一节** ——
