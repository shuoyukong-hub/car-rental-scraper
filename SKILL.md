...
所以换城市要一起给:**`--city <区号> --lng <经度> --lat <纬度> --poi-id <点> --location <名称>`**。
...
返的是**码不是城市名**(码的含义按电话区号常识判断,如 020 广州 / 027 武汉 / 0755 深圳 / 0898 海口 / 0899 三亚)。换城市后**核对车商是否合理**——数据里没有门店地址字段,只能靠车商判断。
